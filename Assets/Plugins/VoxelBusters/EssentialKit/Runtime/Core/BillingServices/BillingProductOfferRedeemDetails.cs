namespace VoxelBusters.EssentialKit
{
    ...
    public class BillingProductOfferRedeemDetails
    {
        ...
        public class IosProperties
        {
            ...
            */
            public IosProperties(string offerId, string keyId, string nonce, string signature, long timestamp)
            {
                OfferId = offerId;
                KeyId = keyId;
                Nonce = nonce;
        ...
        public class AndroidProperties
        {
            ...
            public AndroidProperties(string offerId)
            {
                OfferId = offerId;
            }
        ...
        public class Builder
        {
            ...
            /// <param name="signature">The cryptographic signature of the offer parameters.</param>
