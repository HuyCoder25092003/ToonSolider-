...
namespace VoxelBusters.EssentialKit
{
    ...
    public class RateMyAppUnitySettings  : SettingsPropertyGroup
    {
        ...
        [SerializeField]
        [Tooltip("Automatically show the rating promt when conditions are met. This presents as soon as conditions are met on app launch. Disable this if you want to control on when to show it with the help of RateMyApp.IsAllowedToRate + RateMyApp.AskForReviewNow methods.")]
