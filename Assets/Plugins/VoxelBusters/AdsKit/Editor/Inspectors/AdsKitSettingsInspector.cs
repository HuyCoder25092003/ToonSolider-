...
namespace VoxelBusters.AdsKit.Editor
{
	...
	public class AdsKitSettingsInspector : SettingsObjectInspector
	{
        ...
        {
            return !name.Equals(AdNetworkServiceId.kAdColony);
        }
        ...
        private void DrawNetworkServiceSectionDetails(EditorSectionInfo section)
        {
            ...
            if (asset.IsInstalled())
            {
                ...
                {
                    EditorApplication.delayCall += () => asset.Uninstall();
                }
            }
        ...
        private void DrawNetworkSettingsProperties(string networkId, EditorSectionInfo section)
        {
            ...
            if (string.Equals(networkId, AdNetworkServiceId.kAdColony))
            {
                DrawStringProperty("App Id", apiKeyProperty);
            }
            else if (string.Equals(networkId, AdNetworkServiceId.kAppLovin))
            {
            ...
            else if (string.Equals(networkId, AdNetworkServiceId.kTapjoy))
            {
                DrawStringProperty("iOS Sdk Key", apiKeyOverridesProperty.FindPropertyRelative("m_ios"));
                DrawStringProperty("Android Sdk Key", apiKeyOverridesProperty.FindPropertyRelative("m_android"));
            }
            else if (string.Equals(networkId, AdNetworkServiceId.kUnityAds))
            {
                DrawStringProperty("iOS Game Id", apiKeyOverridesProperty.FindPropertyRelative("m_ios"));
                DrawStringProperty("Android Game Id", apiKeyOverridesProperty.FindPropertyRelative("m_android"));
            }
            else if (string.Equals(networkId, AdNetworkServiceId.kVungle))
            {
                DrawStringProperty("App Id", apiKeyProperty);
            }
